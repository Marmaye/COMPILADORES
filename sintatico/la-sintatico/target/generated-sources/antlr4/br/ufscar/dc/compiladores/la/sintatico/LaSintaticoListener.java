...
public interface LaSintaticoListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LaSintaticoParser#op_logico1}.
	 * @param ctx the parse tree
	 */
	void enterOp_logico1(LaSintaticoParser.Op_logico1Context ctx);
	/**
	 * Exit a parse tree produced by {@link LaSintaticoParser#op_logico1}.
	 * @param ctx the parse tree
	 */
	void exitOp_logico1(LaSintaticoParser.Op_logico1Context ctx);
	/**
	 * Enter a parse tree produced by {@link LaSintaticoParser#op_logico2}.
	 * @param ctx the parse tree
	 */
	void enterOp_logico2(LaSintaticoParser.Op_logico2Context ctx);
	/**
	 * Exit a parse tree produced by {@link LaSintaticoParser#op_logico2}.
	 * @param ctx the parse tree
	 */
	void exitOp_logico2(LaSintaticoParser.Op_logico2Context ctx);
}