...
import br.ufscar.dc.compiladores.la.gerador.LAParser;
...
public class LaSemanticoUtils {
    ...
    public static Tipos verificarTipo(LAParser.Tipo_basicoContext contexto){
        Tipos tipo;
    ...
    public static Tipos verificarTipo(LAParser.Valor_constanteContext contexto){
        Tipos tipo;
    ...
    //Verificar tipo
    public static Tipos verificarTipo(Escopos escopos, LAParser.TipoContext contexto){
        Tipos tipo;
    ...
    public static Tipos verificarTipo(Escopos escopos, LAParser.Tipo_estendidoContext contexto){
    ...
    private static Tipos verificarTipo(Escopos escopos, LAParser.Tipo_basico_identContext contexto){
        Tipos tipo;
    ...
    private static Tipos verificarTipo(Escopos escopos, LAParser.RegistroContext contexto){
    ...
    public static Tipos verificarTipo(Escopos escopos, LAParser.IdentificadorContext contexto){
    ...
    public static Tipos verificarTipo(Escopos escopos, LAParser.ExpressaoContext contexto){
    ...
    private static Tipos verificarTipo(Escopos escopos, LAParser.Termo_logicoContext contexto){
    ...
    private static Tipos verificarTipo(Escopos escopos, LAParser.Fator_logicoContext contexto){
    ...
    private static Tipos verificarTipo(Escopos escopos, LAParser.Parcela_logicaContext contexto){
        Tipos tipo;
    ...
    private static Tipos verificarTipo(Escopos escopos, LAParser.Exp_relacionalContext contexto){
    ...
    public static Tipos verificarTipo(Escopos escopos, LAParser.Exp_aritmeticaContext contexto){
    ...
    public static Tipos verificarTipo(Escopos escopos, LAParser.TermoContext contexto){
    ...
    private static Tipos verificarTipo(Escopos escopos, LAParser.FatorContext contexto){
    ...
    private static Tipos verificarTipo(Escopos escopos, LAParser.ParcelaContext contexto){
        Tipos tipo;
    ...
    public static Tipos verificarTipo(Escopos escopos, LAParser.Parcela_unarioContext contexto){
        Tipos tipo = TiposLa.INVALIDO;
    ...
    private static Tipos verificarTipo(Escopos escopos, LAParser.Parcela_nao_unarioContext contexto){
        Tipos tipo;
        if(contexto.CADEIA() != null){
            tipo = TiposLa.LITERAL;
        }
